 ...
 *
 */
class ComGivesDatabaseBehaviorUploadable extends KDatabaseBehaviorAbstract {
	...
	public function __construct(KConfig $config = null)
	{
		...
		$this->_uploads		= $config->uploads;
		$this->_filter		= $config->filter;
		$this->_thumbs		= $config->thumbs;
		$this->_fieldname	= $config->fieldname;
		$this->_memory_limit	= $config->memory_limit;
	}
